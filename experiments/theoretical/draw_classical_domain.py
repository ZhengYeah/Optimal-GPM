...
plt.plot(data['x'], data['SW-C'], label='SW', linewidth=2, linestyle='--', color=[0, 0, 0])
plt.plot(data['x'], data['PM-C'], label='PM', linewidth=2, linestyle='-', color=[0, 0, 1], marker='+', markersize=8, markevery=2)
plt.plot(data['x'], data['Optimal'], label='GPM', linewidth=2, linestyle='-', color=[1, 0, 0])
plt.plot(data['x'], data['Unbias-GPM'], label='GPM (unbias)', linewidth=2, linestyle='--', color=[1, 0, 1])
...
plt.figure(figsize=(5, 4))
plt.plot(data['Epsilon'], data['SW-C'], label='SW', linewidth=2, linestyle='--', color=[0, 0, 0])
plt.plot(data['Epsilon'], data['PM-C'], label='PM', linewidth=2, linestyle='-', color=[0, 0, 1], marker='+', markersize=8)
